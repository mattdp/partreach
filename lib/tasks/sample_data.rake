# first, run
# >import 'DataEntry'; require DataEntry; csv_to_tags("https://s3.amazonaws.com/temp_for_uploading/tags_v11.csv")
...
task populate: :environment do
	...
	manufacturer = Manufacturer.create_or_reference_manufacturer("Platysys")
	m1 = Machine.create_or_reference_machine({name: "Printerizer", manufacturer_id: manufacturer_id})
	m2 = Machine.create_or_reference_machine({name: "Extrudinator", manufacturer_id: manufacturer_id})
