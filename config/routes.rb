Partreach::Application.routes.draw do
  ...
  get '/comments/later/:comment_id', to: 'comments#later', as: 'comments_later'
  get '/comments/request_for_review/:comment_id', to: 'comments#request_for_review', as: 'comments_request_for_review'
