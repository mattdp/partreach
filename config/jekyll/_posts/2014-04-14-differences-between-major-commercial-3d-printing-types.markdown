...
<p>A common request we get from customers is to separate the signal from the noise with regards to which 3D printing methods are actually accessible to people looking to get their parts made. Here’s a quick practical overview highlighting the different commercial 3D printing technologies on the market that you can use right now. I don’t know what you were hoping to accomplish in the next 25 minutes, but if it was becoming an expert in commercial 3D printing, then you’re in the right place. Enjoy!</p>

<p><strong>Disclaimer 1:</strong> We’ve decided to included hobbyist 3D printers (aka Fused Filament Fabrication) for comparison and because there are <a href="httpss://www.supplybetter.com/blog/choosing-fff-vs-fdm.html" target="_blank">many practical applications</a> for why you’d want to use it for prototyping over FDM. </p>
...
<div>
	...
	<p>Here's another promotional video highlighting the <a href="httpss://www.youtube.com/v/gLxve3ZOmvc&start=117&end=197" target="_blank">post processing techniques used for SLS</a> in producing engineering-grade parts by 3D Systems.</p>
</div>
...
<div>
	...
	<p>Bonus video of a <a href="https://www.youtube.com/watch?v=sC-AHm6dS44#t=61" target="_blank">huge 3D printed wrench</a> printed on a polyjet machine</p>
</div>
