...
<p>A common request we get from customers is to separate the signal from the noise with regards to which 3D printing methods are actually accessible to people looking to get their parts made. Here’s a quick practical overview highlighting the different commercial 3D printing technologies on the market that you can use right now. Enjoy!</p>

<p><strong>Disclaimer 1:</strong> We’ve decided to included hobbyist 3D printers (aka Fused Filament Fabrication) for comparison and because there are <a href="https://www.supplybetter.com/blog/choosing-fff-vs-fdm.html" target="_blank">many practical applications</a> for why you’d want to use it for prototyping over FDM. </p>
<p><strong>Disclaimer 2:</strong> Most of these videos are promotional videos for the companies that make the 3D printers themselves. We've done our best to cut out all the fluff and give you just the interesting bits. 
...
<div>
	<p>A great example of FDM's capabilities is found in the middle of this promotional video of the Fortus 900mc by Stratasys. Notice how the large build volume and liberal use of support material allows for huge end-use parts. <strong>Best use case:</strong> Large custom brackets that need to perform well mechanically for either prototype or production applications.</p> 
...
<div>
	<p>The best video example we found is this beautiful time-lapse of an Ultimaker FFF machine in action. You'll see that it links to the same page as FDM. This can be confusing for a lot of people, so be sure to check out our post covering some of the <a href="https://www.supplybetter.com/blog/choosing-fff-vs-fdm.html" target="_blank">important differences between FDM vs. FFF</a>. <strong>Best use case:</strong> one-off, single use low cost parts.</p>
...
<div>
	<p>In 2010 Shapeways released a promotional video that succinctly demonstrates the different steps involved in SLS 3D printing. What's important to notice here is that after the printing process is complete the parts need to be allowed to cool for a few hours before the excess powder can be removed. Chances are if you're aware of 3D printing you've heard of online service bureaus like Shapeways, and in a previous post we cover <a href="https://www.supplybetter.com/blog/shapeways-vs-supplybetter.html" target="_blank">the major differences between using Shapeways versus other shops</a> we can help you find using SupplyBetter.</p>
	...
	<p>Here's another promotional video highlighting the <a href="https://www.youtube.com/v/gLxve3ZOmvc&start=117&end=197" target="_blank">post processing techniques used for SLS</a> in producing engineering-grade parts by 3D Systems.</p>
</div>
...
<!-- 
	...
	James feedback
	[] more commentary about pros cons - do something to bring it home
	[x] get rid of bashing of videos
	[x] fix intro to be authoritative
	[x] make sure all the links works
	Matt feedback
	[x] "large build volume AND liberal use of support material"
	[x] bolding for use cases
	[] Make each section's opening sentence a full sentence
-->