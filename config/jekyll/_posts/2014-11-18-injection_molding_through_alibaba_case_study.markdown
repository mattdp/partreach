...
This post is about one, relatively simple, hardware product and how SupplyBetter helped get it made. Our goal is to provide as detailed an account of the steps involved so that those currently in the middle of (or about to embark on) a serious hardware project can learn from our experience. Finding a company to make the parts for a custom product that can't be bought from a website or catalog (a.k.a "outsourcing") is often challenging since the effort necessary for success involves the intersection of two very different skillsets: engineering and business. If you're not good at both you can quickly find yourself <a href="http://money.cnn.com/2012/12/18/technology/innovation/kickstarter-ship-delay/index.html" target="_blank">ill-equipped to address the tradeoffs</a> that need to be made in order to manufacture your product.

With this project we can keep discussion of engineering requirements to a minimum while being able to effectively illustrate the business risks involved and attention to detail necessary to outsource custom mechanical parts*. While the following indiviual details may only be useful on a case-by-case basis, the insights gained and lessons learned apply to anyone developing hardware. 

<div class="footer" align="bottom">*In case you're wondering just which kinds of engineering details we're thankful we don't have to discuss, here is a short list: <a href="http://en.wikipedia.org/wiki/Geometric_dimensioning_and_tolerancing" targer="_blank">GD&T</a> interpretation, <a href="http://en.wikipedia.org/wiki/Statistical_process_control" target="_blank">Statistical Process Control (SPC)</a>, Intellectual Property (IP) concerns, certifications (e.g. UL, CE, etc), and technical/engineering language barriers. </div>
...
tl;dr: SMBC could not make larger batches due to the limitations imposed by the manufacturing process used to produce the original run of Gulpos.
...
Despite the success of the first run of Gulpos, it didn't make sense to produce another run. Not including their time spent sourcing and managing the batch, SMBC just barely broke even selling Gulpo Mark I. It was too expensive to manufacture given their current method, and the product didn't look as good as they wanted it to. Their choice of laser cutting, while a great decision for prototyping the product, was not a suitable manufacturing process going forward.  
...
To better understand the decision made in making Gulpo Mark II, here are the details from previous section composed into a summary of requirements:
...
<li>Mold polishing (to achieve glossy surface finish)</li>
...
That said, we did not yet have a supplier network established overseas for the supplier profile discussed in the previous section. So where do you go right now when you need a consumer product made overseas? Alibaba. 

Alibaba can be ridiculously intimidating. A common perception held by many hardware designers is that reaching out to suppliers on Alibaba can be akin to directly emailing scammers to let them know you're their newest victim. While there are indeed quality suppliers to be found on Alibaba's marketplace, having an entire ocean and legal system between you and the people you're sending money to means there is very little recourse to be had for manufacturing deals gone awry. The suspicion that <a href="http://www.economist.com/blogs/newsbook/2011/02/online-fraud_scandal_china" target="_blank">you may be dealing with a fraudulent company is not unfounded</a>. This why the in-person Asian factory tour is such a common occurrence with hardware companies sourcing overseas. For excellent first-person accounts of what the manufacturing ecosystem looks like, I highly recommend <a href="http://joi.ito.com/weblog/2014/09/01/shenzhen-trip-r.html" target="_blank">Joi Ito's blog post about sourcing electronics</a>, <a href="http://blog.theopencompany.net/post/29079747110/going-to-china-to-make-the-perfect-tee" target="_blank">The Open Company's blog series on making a t-shirt</a>, and <a href="http://formdevices.com/blog/index.html" target="_blank">Form Devices blog</a> (with three excellent posts on manufacturing in Shenzhen, China).

Neither SMBC nor SupplyBetter was willing to jump on a plane and go on a factory tour since the price of the plane tickets alone would likely amount to more than the cost of the entire production run. For this project we were stuck with only online resources and our wits.
...
Now it was just a matter of figuring out the correct one to use for Gulpo Mark II.
